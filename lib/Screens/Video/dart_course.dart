...
class DartCourse extends StatelessWidget {
  final List<Map<String, dynamic>> Dartmodules;

  DartCourse({required this.Dartmodules});
            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  showSearch(
                    context: context,
                    delegate: LessonSearchDelegate(Dartmodules),
                  );
                },
              ),
            ],
            ...
            body: Column(
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    children: [
                      LessonList(Fluttermodules: Dartmodules),
